            ...
            <View style={styles.container}>
                <ScrollView>
                    ...
                    <View style={styles.view2}>
                        <Text style={styles.text3}>Chọn 1 loại món ăn</Text>
                        <View style={styles.view3}>
                            <Text style={styles.text4}>Bắt buộc</Text>
                        </View>
                    </View>
                                    ...
                                    {this.state.required[this.state.preference.indexOf(item)] && (
                                        <View style={styles.view9}>
                                            <Text style={styles.text7}>
                                                {this.state.minimum_quantity[this.state.preference.indexOf(item)]} Bắt
                                                buộc
                                            </Text>
                                        </View>
                                    )}
                ...
                <View style={styles.view17}>
                    <View style={styles.view18}>
                        <Text style={styles.text10}>Thêm 1 sản phẩm giá R78.21</Text>
                    </View>
                </View>
            </View>
        );
